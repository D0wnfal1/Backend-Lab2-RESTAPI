...
namespace Backend_Lab2_RESTAPI.Migrations
{
    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "DefaultCurrencyId", "Name" },
                values: new object[,]
                {
                    { 1, 1, "John Doe" },
                    { 2, 3, "Jane Smith" }
            ...
            migrationBuilder.InsertData(
                table: "Records",
                columns: new[] { "Id", "Amount", "CategoryId", "CreateTime", "CurrencyId", "UserId" },
                values: new object[,]
                {
                    { 1, 50.75m, 1, new DateTime(2024, 11, 21, 12, 59, 4, 663, DateTimeKind.Utc).AddTicks(6105), 2, 1 },
                    { 2, 20.00m, 2, new DateTime(2024, 11, 21, 12, 59, 4, 663, DateTimeKind.Utc).AddTicks(6125), null, 2 }
                });
